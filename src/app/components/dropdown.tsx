        ...
        <DropdownMenu.Root>
            <DropdownMenu.Trigger className="outline-none focus:outline-none" asChild>
                <button
                    ...
                    className="relative w-24 h-10 text-white bg-blue-300 hover:bg-blue-800  font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center  shadow-lg shadow-blue-500/50 outline-none focus:outline-none"
                >
                    {label}
                    <svg
            ...
            <DropdownMenu.Portal>
                <DropdownMenu.Content
                    className={`${
                        Object.keys(nodes).length > 0 ? "" : "hidden"
