...
export default function Home() {
  ...
  return (
    <div className="text-biru p-7 h-screen">
          ...
          <div className="max-w-lg space-y-4">
            <div className="max-w-xs">
              ...
              <form onSubmit={handleSubmit}>
                <button
                  className="relative w-32 text-white bg-blue-300 hover:bg-blue-800  font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 shadow-lg shadow-blue-500/50"
                  type="submit"
                >
                  <input
            ...
            <div className="max-w-xs">
              ...
              <div className="flex items-center mb-4">
                ...
                <label
                  for="default-radio-1"
                  class="ml-2 text-sm font-medium text-blue"
                >
                  UCS
                </label>
              </div>
